...
export function ScheduleGrid({ 
  ...
  return (
    <>
      ...
      <div className="hidden md:block overflow-x-auto overflow-y-visible border border-black rounded-lg shadow-lg bg-white relative print:border-none print:shadow-none print:overflow-hidden print:block" id="schedule-grid">
